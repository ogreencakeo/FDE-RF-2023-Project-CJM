    ...
    return(
        <>
            <div className="area-type-btn">
                <nav>
                    <ul>
                        <li><button onClick={() => areaChangeFn('nintendo')} key={0}>슈퍼 닌텐도 월드™</button></li>
                        <li><button onClick={() => areaChangeFn('harrypotter')}  key={1}>위저딩 월드 오브 해리 포터™</button></li>
                        <li><button onClick={() => areaChangeFn('minion')}  key={2}>미니언 파크</button></li>
                        <li><button onClick={() => areaChangeFn('wonderland')}  key={3}>원더랜드</button></li>
                        <li><button onClick={() => areaChangeFn('jurassicpark')}  key={4}>쥬라기 공원</button></li>
                    </ul>
                </nav>
            </div>
