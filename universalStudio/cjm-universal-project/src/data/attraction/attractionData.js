...
export const attractionData = [
    {
        ...
        image: "attraction1",
        explanation:
            "뉴욕 한켠에 위치한 ‘42nd 스트리트 스튜디오’는 화제의 아티스트들이 앞다투어 전시회를 연다는 유명한 갤러리. 그중 인기 최고의 아티스트, 미니언과 스누피가 여러분을 아틀리에로 초대해 작품을 공개! 새로운 영감을 찾아 헤매던 중이라 어쩌면 당신에게 도와달라고 할지도?! 작품이 완성되면 함께 기념사진을 찍어 보자!",
    },
    {
        idx: "2",
        name: "그로버 콘스트럭션 컴퍼니",
    ...
    },
    {
        ...
        name: "마리오 카트: 쿠파의 도전장™",
        image: "attraction5",
        explanation: `그 유명한 마리오 카트의 세계와 놀라움 가득한 갖가지 코스가 바로 눈앞에 등장한다! 등껍질을 던져 적을 격퇴하면서 마리오 그리고 피치공주와 함께 돌진하라! 파크만의 최신 기술로 실현되는 세계 최초*의 마리오 카트 체험에 두근두근 흥분이 멈추지 않는다!
    ...
    },
    {
        ...
        image: "attraction9",
        explanation:
            "‘미니언 파크’ 가장 안쪽의 유달리 눈에 띄는 그루의 저택. 그곳의 지하 연구실에 사는 미니언들이 가끔씩 저택 앞에 등장해요! 함께 사진을 찍고 교류하면서 서로 친해질 찬스입니다!",
        area: "minion",
    },
    {
        idx: "10",
    ...
    },
    {
        ...
        image: "attraction20",
        explanation:
            "오리지널 3-D 영화에 놀랍도록 새로운 차원의 효과가 더해진 4-D 엔터테인먼트. 세서미 스트리트™의 친구들, 엘모, 쿠키 몬스터, 빅 버드, 버트, 어니와 함께 바다로 잠수하고 하늘을 날아보아요. 상상 속의 세상을 온몸으로 느낄 수 있습니다.",
    },
    {
        idx: "21",
        name: "슈렉 4-D 어드벤처",
        image: "attraction21",
        explanation:
            "드림웍스의 아카데미상 수상작 ‘슈렉’에서 탄생한 파크만의 오리지널 스토리. 슈렉, 동키와 함께 스릴 만점의 새로운 모험을 떠나자! 그곳은 3-D 영화에 새로운 차원의 특수 효과를 더한 4-D의 세계.",
    },
    {
        idx: "22",
    ...
    },
    {
        ...
        image: "attraction24",
        explanation:
            "끝없는 우주 공간 여기저기 흩어져 있는 아름다운 별들 사이를 종횡무진 질주하는 우주선을 타고, 해방감을 만끽하며 우주를 탐험해보아요.",
    },
    {
        idx: "25",
        name: "씽 온 투어",
        image: "attraction25",
        explanation:
            "모든 동물 여러분! 드디어 세계적인 뮤지컬 쇼 ‘씽 온 투어’가 이곳 일루미네이션 시어터에서 막을 올립니다! 그 유명한 “씽(SING)”에 등장한 멋진 싱어의 “실제 캐릭터”들이 모두에게 친숙한 레전드 팝을 파워풀하고 소울 충만한 목소리로 눈앞에서 열창! 보고 있노라면 당신의 열기도 틀림없이 최고조로! 동물 사상 최고로 핫한 뮤지컬 쇼 어트랙션에서 모두 함께 씽&샤우팅!!",
    },
    {
        idx: "26",
        name: "애머티 보드워크 게임",
        image: "attraction26",
        explanation:
            "애미티 빌리지의 라군 부근에 위치한 이곳에서는 카니발 게임에 도전할 수 있어요! 어트랙션과 쇼를 즐기는 사이사이나 식후의 포만감을 느낄 때 즈음, 몸을 가볍게 움직여서 게임에 한번 도전해 보세요! 깜찍한 경품을 받을 수 있는 찬스!",
    },
    {
        idx: "27",
        name: "애비의 매지컬 트리",
    ...
    },
    {
        ...
        image: "attraction30",
        explanation:
            "사상 처음으로 7년 연속 세계 No.1 라이드 어트랙션상을 수상한 세계 최고 어트랙션이 세계 최고 기술 ‘4K3D’와 융합하여 전혀 다른 라이드로 변신! 현실과 구별이 가지 않을 정도의 믿을 수 없는 박력과 100가지가 넘는 특수 효과가 가져다주는 차원이 다른 탑승감! 지금까지 경험한 적 없는 차원이 다른 흥분과 만난다!",
    },
    {
        idx: "31",
        name: "엘모의 고 고 스케이트보드",
    ...
    },
    {
        ...
        image: "attraction34",
        explanation:
            "마법지팡이 상자가 천장까지 수북하게 쌓여 있는 먼지 낀 작은 가게 안에서 지팡이 파수꾼과 함께 ‘지팡이가 마법사를 선택하는’ 상황을 체험할 수 있습니다.",
        area: "harrypotter",
    },
    {
        idx: "35",
        ...
        image: "attraction35",
        explanation:
            "지금껏 본 적 없는 엄청난 마법이 당신의 눈앞에서 실제로 일어납니다! 훌륭한 마법사가 되기 위해서 호그와트™ 마법 학교 네 곳의 기숙사 학생들은 마법 연습 중입니다. 성공과 실패를 거듭하면서 열심히 연습하는 학생들과 함께, 눈앞에서 실제로 일어나는 마법의 매력에 빠져 보세요. 용기 있는 마법사 여러분, 마법을 거는 학생들에게 도움을 주세요!",
        area: "harrypotter",
    },
    {
        idx: "36",
        ...
        image: "attraction36",
        explanation:
            "요시의 등에 타고 키노피오대장을 쫓아서 보물찾기 모험을 떠나자! 대장이 깜빡하고 놓고 간 지도를 참고하여 사방에 숨어 있는 3개의 달걀을 찾아내자. 키다리산에서 버섯 왕국을 내려다보기도 하고 깜찍한 아이들과 만나는 등 즐거움이 한가득!",
        area: "nintendo",
    },
    {
        idx: "37",
    ...
    },
    {
        ...
        image: "attraction38",
        explanation:
            "체험자 수 누계 1억 명(※) 돌파. 영화 속의 숨 막히는 스턴트 액션을 그대로 재현하여 절대적인 인기를 얻고 있는 어트랙션 쇼가 진화한다. 새로워진 서라운드 음향 시스템에 의해 폭발이나 총격에 말려든 듯한 압도적인 현장감에 둘러싸인다! 긴박감 넘치는 수상 배틀의 한복판으로 지금, 내던져진다!",
    },
    {
        idx: "39",
        ...
        image: "attraction39",
        explanation:
            "펑키하고 크레이지한 몬스터, 비틀쥬스™와 드라큘라, 늑대 인간, 프랑켄슈타인™, 그리고 프랑켄슈타인의 신부™까지 한밤중의 묘지에 모두 집결. 예전에 사람들을 공포의 늪에 빠뜨린 그들이 이번에는 할리우드에서 익힌 춤과 노래로 주변을 흥분의 도가니로 몰고 갑니다. 유명한 록넘버를 배경으로 펼쳐지는 리얼 라이브 엔터테인먼트를 절대로 놓치지 마세요.",
    },
    {
        idx: "40",
        ...
        image: "attraction40",
        explanation:
            "퍼레이드 카 × 맵핑의 놀라운 현장감이 퍼레이드의 상식을 깬다! 압도적인 마법 장치로 매료시키는 ‘해리 포터’의 세계, 전 세계에서 처음 시도되는 “변형하는 퍼레이드 카”로 짜릿한 흥분을 선사하는 ‘트랜스포머’, 그리고 포효하며 날뛰는 공룡의 세계에 내던져지는 ‘쥬라기 월드’, 거리를 뒤죽박죽 디스코 공간으로 바꾸어버리는 ‘미니언즈’ 등, 끊임없이 밀려오는 궁극의 현장감 넘치는 공간이 현실을 침식하고 당신을 이야기의 한복판으로 이끈다! 기간 한정의 특별 에어리어까지 등장해서 더욱 파워 업!",
    },
    {
        idx: "41",
    ...
    },
    {
        ...
        image: "attraction42",
        explanation:
            "평화로운 항구 마을의 즐거운 보트 투어가 순식간에 돌변하게 됩니다. 갑자기 나타난 거대 식인상어로 인해 생사를 가르는 공포의 투어로 변해 버립니다. 영화 ‘죠스’의 바다를 무대로 한 공포 투어.",
    },
    {
        idx: "43",
    ...
    },
    {
        ...
        image: "attraction44",
        explanation:
            "태고의 공룡과 만나는 탐험에 예상 밖의 트러블 발생. 포효하며 날뛰는 T-렉스에 절체절명, 도망치기 위해 25.9m 밑으로 곤두박질!",
    },
    {
        idx: "45",
        name: "지팡이 마법",
        image: "attraction45",
        explanation:
            "마법사들이 사는 곳, 호그스미드 마을™에서는 당신도 실제로 마법을 걸 수 있어요. 그 유명한 창문과 석조 벽, 그리고 뒷골목에서도 특별한 마법을 걸 수 있어요! 주문을 외우며 지팡이를 휘둘러 보세요. 그러면 갑자기 주변에 눈이 흩날리거나 커다란 솥에서 물이 뿜어져 나와요! 처음에는 실패해도 몇 번이고 연습하다 보면 꼭 잘하게 될 거예요.",
        area: "harrypotter",
    },
    {
        idx: "46",
    ...
    },
    {
        ...
        image: "attraction47",
        explanation:
            "트리위저드 시합을 위해 호그와트™ 마법 학교에 방문한 덤스트랭과 보바통 마법 학교의 퍼포먼스. 파워풀한 액션과 우아한 연기에 빠져드실 것입니다.",
        area: "harrypotter",
    },
    {
        idx: "48",
        ...
        image: "attraction48",
        explanation:
            "골든버섯을 쿠파주니어에게 도둑맞았다! 곳곳에 있는 적들을 쓰러뜨리고 3개의 열쇠를 획득하라! 열쇠를 다 획득한 후에 기다리고 있는 것은 쿠파주니어와의 대흥분 보스 배틀. 자 그럼 쿠파주니어를 무찌르고 무사히 골든버섯을 되찾을 수 있을까!?",
        area: "nintendo",
    },
    {
        idx: "49",
    ...
    },
    {
        ...
        image: "attraction50",
        explanation:
            "파크 중앙의 라군 부근에 위치한 이곳에서는 카니발 게임에 도전할 수 있어요! 어트랙션과 쇼를 즐기는 사이사이나 식후의 포만감을 느낄 때 즈음, 몸을 가볍게 움직여서 게임에 한번 도전해 보세요! 깜찍한 경품을 받을 수 있는 찬스!",
    },
    {
        idx: "51",
        name: "프로그 콰이어",
        image: "attraction51",
        explanation:
            "호그와트™ 마법 학교 학생들의 멋진 화음을 들어보세요. 그리핀도르™, 슬리데린™, 후플푸프™, 래번클로™의 각 기숙사에서 선발한 4명의 합창단이 마법세계의 명곡을 선보입니다. 재능 넘치는 개구리들의 반주에도 주목해 주세요.",
        area: "harrypotter",
    },
    {
        idx: "52",
    ...
    },
    {
        ...
        image: "attraction53",
        explanation:
            "마법세계의 생물인 히포그리프와 하늘을 질주하는 이 라이드는 온 가족이 함께 즐길 수 있는 어트랙션입니다. 해그리드™에게 히포그리프에 대한 올바른 접근 방법을 배운 후 히포그리프로 비행 훈련을 시작합시다. 독수리의 머리와 말의 몸을 가진 히포그리프는 대단히 긍지 높은 마법 생물이므로 다가가기 전에 먼저 인사하는 것을 잊지 마세요. 해그리드의 오두막과 호박밭 하늘을 날아다니는 이 어트랙션에서는 멋진 경관도 즐길 수 있습니다.",
        area: "harrypotter",
    },
    {
        idx: "54",
        ...
        image: "attraction54",
        explanation:
            "언제 어디서나, 무엇이든 알고 싶은 것투성이! 그런 호기심 많은 귀여운 모습으로 전 세계적인 인기를 얻고 있는 ‘원숭이 조지™’가 어트랙션으로! 무대는 애니메이션 제작 스튜디오. 맙소사! 그림 안에 있어야 할 조지가 현실 세계로 뛰쳐나왔다! 처음 만나는 세계에 두근두근 흥미진진, 스튜디오 안을 해맑게 뛰어다니는 조지와 친구가 되어 호기심이 이끄는 대로 마음껏 즐기자!",
    },
    {
        idx: "55",
        name: "피에스타 라티나",
    ...
    },
    {
        ...
        image: "attraction56",
        explanation:
            "이 롤러코스터는 유니버설 스튜디오 재팬의 독창성과 세계 굴지의 롤러코스터 제작회사의 최첨단 기술이 집약되어 마치 하늘을 나는 것 같은 상쾌함을 느낄 수 있는 놀이기구입니다. 좋아하는 배경음악(BGM)을 들으며 눈이 번쩍 뜨일 만한 스릴감을 온몸으로 느껴보세요.",
    },
    {
        idx: "57",
        ...
        image: "attraction57",
        explanation:
            "43m 높이에서 상상할 수 없는 각도로 머리부터 떨어지는 느낌으로 낙하! 어디로 갈지 알 수 없는 예측 불가능한 최고의 스릴과 자극! 괴성과 함께 역방향 롤러코스터(백드롭) 출발!",
    },
    {
        idx: "58",
        image: "attraction58",
